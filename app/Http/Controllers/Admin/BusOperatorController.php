...
class BusOperatorController extends Controller
{
    ...
    public function __construct()
    {
        ...
        //view files
        $this->index_view = 'admin.bus_operator.index';
        $this->create_view = 'admin.bus_operator.create';
        $this->detail_view = 'admin.bus_operator.details';
        $this->profile_view = 'admin.bus_operator.profile';
        $this->edit_view = 'admin.bus_operator.edit';
    ...
    public function store(CustomerRequest $request)
    {
        ...
        $customer = CustomerService::create($input, 'Customer');
