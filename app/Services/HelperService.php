...
class HelperService
{
    ...
    public static function sendNotification(array $noti_data)
    {
        ...
        $user = UserService::getById($noti_data['user_id']);
    ...
    {
        return FileService::getFileUrl($file_url, $file_name, $type);
    }
    ...
    {
        return FileService::file_exists_storage_path($url, $type);
    }
    ...
    {
        return FileService::return_user_default_image();
    }
    ...
    {
        return FileService::file_exists_public_path($url);
    }
    ...
    {
        return FileService::remove_file_public_path($url);
    }
    ...
    {
        return FileService::imageUploader($request, $key, $url, $name);
    }
    ...
    {
        return FileService::multipleImageUploader($request, $key, $url, $name);
    }

    public static function removeImage(Model $model, String $column_name, $url)
    {
        return FileService::removeImage($model, $column_name, $url);
    }
