                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-success px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-success d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6 "><span class="total_vendors">0</span>
                                            </h4>
                                        </span>
                                        <!--end::Svg Icon-->
                                        <a href="#"
                                    ...
                                    <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-primary d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6"><span class="total_purchase">0</span>
                                            </h4>
                                        </span>
                                        <!--end::Svg Icon-->
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-danger d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6"><span class="total_unrecieved_bill">0</span>
                                            </h4>
                                        </span>
                                        <!--end::Svg Icon-->
                                        <a href="#"
                                    ...
                                    <div class="col bg-light-info px-6 py-8 rounded-2 me-7 mb-7">
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-info d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6">₭ <span class="total_unpaid_amount">0</span>
                                            </h4>
                                        </span>
                                        <!--end::Svg Icon-->
                                        <a href="#"
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-danger d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6">₭ <span
                                ...
                                <div class="row g-0">
                                    ...
                                    <div class="col bg-light-danger px-6 py-8 rounded-2 me-7 mb-7"
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-dark d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6">₭ <span class="total_dept_balance">0</span>
                                            </h4>
                                        </span>
                                        <!--end::Svg Icon-->
                                    ...
                                    <div class="col bg-light-success px-6 py-8 rounded-2 mb-7">
                                        ...
                                        <span class="svg-icon svg-icon-4x svg-icon-success d-block my-2">
                                            ...
                                            <h4 class="text-white fw-bold fs-6"> <span class="total_asset">0</span>
                                            </h4>
                                        </span>
                                        <!--end::Svg Icon-->
                                        <a href="#"
