...
<div class="card pt-4 mb-6 mb-xl-9">
    ...
    <div class="card-body pt-0 pb-5">
        ...
        <div class="table-responsive">
            <!--begin::Table-->
            <table class="table align-middle table-row-dashed gy-5" id="kt_table_customers_login_session">
                <!--begin::Table body-->
...
<div class="card pt-4 mb-6 mb-xl-9">
    ...
    <div class="card-body">
        <!--begin::Form-->
        <form class="form" id="kt_customers_email_notification_form">
            <!--begin::Item-->
            <div class="d-flex">
                <!--begin::Checkbox-->
            ...
            <div class="d-flex justify-content-end align-items-center mt-12">
                ...
                <button type="button" class="btn btn-light me-5"
                    id="kt_customers_email_notification_cancel">Cancel</button>
                <!--end::Button-->
                <!--begin::Button-->
                <button type="button" class="btn btn-primary" id="kt_customers_email_notification_submit">
